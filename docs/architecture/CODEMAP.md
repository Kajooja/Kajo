...
| Room feature | `apps/mobile/src/features/room/RoomScreen.tsx` | Edge-to-edge 2D Room backdrop plus Home-only bookshelf/projector interaction layer. The shell retains the same scene beneath all authenticated routes; #149 keeps Home free of standalone title/helper/sign-out chrome |
