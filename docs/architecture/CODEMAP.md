...
| Discovery feature | `apps/mobile/src/features/discovery/` | Grid/detail/swipe, hosted Prediction V0, rating/not-interested/save state, ordered persistence, undo, cooldown and global shell. Separate Sprint 009 shared suggestion helper is being removed under #149 |
