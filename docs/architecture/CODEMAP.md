...
| Room feature | `apps/mobile/src/features/room/RoomScreen.tsx` | Edge-to-edge code-native 2D Room with fireplace, rug/bench, bookshelf, low TV console and phase-aware window sky plus Home-only BOOK/MOVIE interaction targets. The shell retains the same scene beneath all authenticated routes; #149 keeps Home free of standalone title/helper/sign-out chrome |
