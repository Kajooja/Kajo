create index events_profile_type_item_occurred_at_idx
  on public.events (profile_id, event_type, occurred_at desc, item_id)
...
begin
  ...
  scored as (
    select
      ...
      - case when consumed then 100.0 else 0.0 end as final_score
